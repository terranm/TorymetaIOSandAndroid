...
import com.tnmeta.torymeta.databinding.CommonBuyAlertDialogBinding
...
object CommonBuyAlertDialog {
    private const val THEME_ID = R.style.AppTheme_Dialog

    class Builder(val context: Context) {

        private val viewBinding = CommonBuyAlertDialogBinding.inflate(LayoutInflater.from(context))
