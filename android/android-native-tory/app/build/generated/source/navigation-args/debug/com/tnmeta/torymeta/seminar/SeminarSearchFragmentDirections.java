...
public class SeminarSearchFragmentDirections {
  private SeminarSearchFragmentDirections() {
  }

  @NonNull
  public static ActionSeminarSearchToDetailSeminar actionSeminarSearchToDetailSeminar(
      @NonNull SeminarInfo param) {
    return new ActionSeminarSearchToDetailSeminar(param);
  }

  @NonNull
  public static ActionSeminarSearchToTorymetaWorld actionSeminarSearchToTorymetaWorld(
      @NonNull SwitchScene param) {
    return new ActionSeminarSearchToTorymetaWorld(param);
  }
  ...
  public static class ActionSeminarSearchToDetailSeminar implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionSeminarSearchToDetailSeminar(@NonNull SeminarInfo param) {
      if (param == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSeminarSearchToDetailSeminar setParam(@NonNull SeminarInfo param) {
      if (param == null) {
        throw new IllegalArgumentException("Argument \"param\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("param", param);
    ...
    public int getActionId() {
      return R.id.action_seminar_search_to_detail_seminar;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionSeminarSearchToDetailSeminar that = (ActionSeminarSearchToDetailSeminar) object;
    ...
    public String toString() {
      return "ActionSeminarSearchToDetailSeminar(actionId=" + getActionId() + "){"
          + "param=" + getParam()
          + "}";
    }
  }

  public static class ActionSeminarSearchToTorymetaWorld implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionSeminarSearchToTorymetaWorld(@NonNull SwitchScene param) {
      if (param == null) {
        throw new IllegalArgumentException("Argument \"param\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("param", param);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSeminarSearchToTorymetaWorld setParam(@NonNull SwitchScene param) {
      if (param == null) {
        throw new IllegalArgumentException("Argument \"param\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("param", param);
    ...
    @Override
    public int getActionId() {
      return R.id.action_seminar_search_to_torymeta_world;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionSeminarSearchToTorymetaWorld that = (ActionSeminarSearchToTorymetaWorld) object;
      if (arguments.containsKey("param") != that.arguments.containsKey("param")) {
        return false;
      }
      if (getParam() != null ? !getParam().equals(that.getParam()) : that.getParam() != null) {
    ...
    @Override
    public String toString() {
      return "ActionSeminarSearchToTorymetaWorld(actionId=" + getActionId() + "){"
          + "param=" + getParam()
          + "}";
    }
  }
