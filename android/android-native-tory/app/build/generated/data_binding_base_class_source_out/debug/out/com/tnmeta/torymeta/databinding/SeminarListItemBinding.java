...
public final class SeminarListItemBinding implements ViewBinding {
  @NonNull
  ...
  private SeminarListItemBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatTextView detailComment, @NonNull AppCompatTextView divide,
      @NonNull AppCompatImageView iconLock, @NonNull ConstraintLayout imageLayout,
      @NonNull AppCompatImageView imgRoom, @NonNull AppCompatImageView imgTeacher,
      @NonNull AppCompatButton join, @NonNull AppCompatTextView seminarCount,
      @NonNull AppCompatTextView seminarDate, @NonNull AppCompatTextView seminarMaxCount,
      ...
      @NonNull AppCompatTextView seminarTitle, @NonNull ConstraintLayout thumbnailLayout) {
  ...
  @NonNull
  public static SeminarListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SeminarListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.seminar_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SeminarListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SeminarListItemBinding((ConstraintLayout) rootView, detailComment, divide,
          iconLock, imageLayout, imgRoom, imgTeacher, join, seminarCount, seminarDate,
          seminarMaxCount, seminarMy, seminarMyCreateLayout, seminarSituation,
          seminarSituationLayout, seminarTitle, thumbnailLayout);
    }
