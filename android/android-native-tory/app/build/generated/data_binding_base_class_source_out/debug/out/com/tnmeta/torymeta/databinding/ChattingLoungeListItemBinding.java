...
public final class ChattingLoungeListItemBinding implements ViewBinding {
  @NonNull
  ...
  private ChattingLoungeListItemBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ChattingLoungeListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ChattingLoungeListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.chatting_lounge_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ChattingLoungeListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChattingLoungeListItemBinding((ConstraintLayout) rootView, chattingCreator,
