...
public final class ChattingLoungeRoomListItemBinding implements ViewBinding {
  @NonNull
  ...
  private ChattingLoungeRoomListItemBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ChattingLoungeRoomListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ChattingLoungeRoomListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.chatting_lounge_room_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ChattingLoungeRoomListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChattingLoungeRoomListItemBinding((ConstraintLayout) rootView, chattingCreator,
