...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull ConstraintLayout rootView,
      @NonNull LottieAnimationView animationView, @NonNull AppCompatImageView imgLogo,
      @NonNull UnityContainer unity, @NonNull ConstraintLayout unityLayout) {
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSplashBinding((ConstraintLayout) rootView, animationView, imgLogo, unity,
          unityLayout);
    }
