...
public final class CommonBuyAlertDialogBinding implements ViewBinding {
  @NonNull
  private final ConstraintLayout rootView;

  @NonNull
  public final AppCompatTextView addMessage;
  ...
  private CommonBuyAlertDialogBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatTextView addMessage, @NonNull ConstraintLayout btnLayout,
      @NonNull AppCompatTextView divider, @NonNull ConstraintLayout imageLayout,
  ...
  @NonNull
  public static CommonBuyAlertDialogBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CommonBuyAlertDialogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.common_buy_alert_dialog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CommonBuyAlertDialogBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.add_message;
      AppCompatTextView addMessage = ViewBindings.findChildViewById(rootView, id);
      if (addMessage == null) {
        break missingId;
      }
      ...
      return new CommonBuyAlertDialogBinding((ConstraintLayout) rootView, addMessage, btnLayout,
          divider, imageLayout, message, negativeBtn, positiveBtn, title);
    }
