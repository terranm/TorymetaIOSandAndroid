//
//  ToryTransactionHistoryViewModel.swift
//  IOS-Native-Together
//
...
final class ToryTransactionHistoryViewModel: RefactoringBaseViewModel {
    ...
    override init() {
        ...
        currentFilter
            ...
            .flatMap { [weak self] in
                ...
                return self.repository.getToryTransactionHistoryList(period: $0.filterCode,
        ...
        paging
            ...
            .flatMap { [weak self] in
                guard let self = self else { return Observable<[PointTransactionListResultDto.Item]>.empty() }
                return self.repository.getToryTransactionHistoryList(period: self.currentFilter.value.filterCode,
                                                         page: $0,
                                                         lenth: self.pageSize)
            }
