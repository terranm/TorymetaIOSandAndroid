//
//  ToryTransactionHistoryViewController.swift
//  IOS-Native-Together
//
...
final class ToryTransactionHistoryViewController: RefactoringBaseViewController<ToryTransactionHistoryViewModel>, IndicatorInfoProvider {
    override var analyticsId: String { AnalyticsManager.toryChargeTransaction }
    ...
    let emptyLabel = WilldUILabel.create(font: .regular16,
                                         text: localizable.toryTransactionNoHistory(),
                                         color: .togetherGray2)

    override func bind(_ viewModel: ToryTransactionHistoryViewModel) {
...
//        }
    ...
    func indicatorInfo(for pagerTabStripController: XLPagerTabStrip.PagerTabStripViewController)
        ...
        return IndicatorInfo(title: localizable.toryTransactionHistory())
    }

}

extension ToryTransactionHistoryViewController: UICollectionViewDataSource {
...
extension ToryTransactionHistoryViewController: UITableViewDataSource {
