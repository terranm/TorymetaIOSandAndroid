//
//  ChattingLoungeChattingListItemTableViewCell.swift
//  IOS-Native-Together
//
...
final class ChattingLoungeChattingListItemTableViewCell: BaseTableViewCell {
    ...
    func bind(data: ChattingLoungeChattingRoomList.Item, _ viewModel: ChattingLoungeChattingListViewModel) {
    ...
    private func attribute() {
        ...
        secretIconImageView.image = R.image.chatting_lounge_chatting_list_secret()

        entranceeButton.layer.cornerRadius = 8
        entranceeButton.backgroundColor = .togetherPurple

        entranceButtonLabel.text = localizable.chattingLoungeChattingListEntrance()
